...
const Sidebar = () => {
  ...
  return (
    <Box sx={{
      ...
      '& .pro-inner-item':{
        padding:'5px 3px 35px 20px !important'
      },
          ...
          {!isCollapsed &&(
            <Box mb='25px'>
              <Box display='flex' justifyContent='center' alignItems='center'>
                ...
                src={'../../assets/yussuf kheir.jpg'}
                style={{cursor:'pointer', borderRadius:'50%'}}
                />
              </Box>
              <Box textAlign='center'>
                <Typography variant='h2' color={colors.grey[100]} fontWeight='bold' sx={{m:'10px 0 0 0'}}>Abdikher Maalim</Typography>
